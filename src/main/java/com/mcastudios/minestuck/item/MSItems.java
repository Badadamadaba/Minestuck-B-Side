...
import com.mcastudios.minestuck.entity.item.CrewPosterEntity;
import com.mcastudios.minestuck.entity.item.MetalBoatEntity;
import com.mcastudios.minestuck.entity.item.SbahjPosterEntity;
import com.mcastudios.minestuck.entity.item.ShopPosterEntity;
import com.mcastudios.minestuck.fluid.MSFluids;
import com.mcastudios.minestuck.item.artifact.CruxiteAppleItem;
import com.mcastudios.minestuck.item.artifact.CruxitePotionItem;
import com.mcastudios.minestuck.item.block.*;
import com.mcastudios.minestuck.item.foods.DrinkableItem;
import com.mcastudios.minestuck.item.foods.HealingFoodItem;
import com.mcastudios.minestuck.item.foods.UnknowableEggItem;
import com.mcastudios.minestuck.item.foods.SurpriseEmbryoItem;
import com.mcastudios.minestuck.item.weapon.*;
import com.mcastudios.minestuck.item.weapon.projectiles.BouncingProjectileWeaponItem;
import com.mcastudios.minestuck.item.weapon.projectiles.ConsumableProjectileWeaponItem;
import com.mcastudios.minestuck.item.weapon.projectiles.ReturningProjectileWeaponItem;
...
import static com.mcastudios.minestuck.block.MSBlocks.*;
...
public class MSItems
{
	...
	public static final RegistryObject<Item> MOONSTONE = REGISTER.register("moonstone", () -> new Item(new Item.Properties().tab(MSItemGroup.MAIN)));
	public static final RegistryObject<Item> MOONSTONE_CHISEL = REGISTER.register("moonstone_chisel", () -> new Item(new Item.Properties().durability(64).tab(MSItemGroup.MAIN)));
	...
	public static final RegistryObject<Item> ZILLYSTONE_SHARD = REGISTER.register("zillystone_shard", () -> new Item(new Item.Properties().stacksTo(64).tab(MSItemGroup.MAIN)));
	...
	public static final RegistryObject<BlockItem> GRIST_BLOCK_AMBER = registerBlockItem(MSBlocks.GRIST_BLOCK_AMBER, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_AMETHYST = registerBlockItem(MSBlocks.GRIST_BLOCK_AMETHYST, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_ARTIFACT = registerBlockItem(MSBlocks.GRIST_BLOCK_ARTIFACT, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_BUILD = registerBlockItem(MSBlocks.GRIST_BLOCK_BUILD, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_CAULK = registerBlockItem(MSBlocks.GRIST_BLOCK_CAULK, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_CHALK = registerBlockItem(MSBlocks.GRIST_BLOCK_CHALK, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_COBALT = registerBlockItem(MSBlocks.GRIST_BLOCK_COBALT, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_DIAMOND = registerBlockItem(MSBlocks.GRIST_BLOCK_DIAMOND, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_GARNET = registerBlockItem(MSBlocks.GRIST_BLOCK_GARNET, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_GOLD = registerBlockItem(MSBlocks.GRIST_BLOCK_GOLD, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_IODINE = registerBlockItem(MSBlocks.GRIST_BLOCK_IODINE, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_MARBLE = registerBlockItem(MSBlocks.GRIST_BLOCK_MARBLE, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_MERCURY = registerBlockItem(MSBlocks.GRIST_BLOCK_MERCURY, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_QUARTZ = registerBlockItem(MSBlocks.GRIST_BLOCK_QUARTZ, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_RUBY = registerBlockItem(MSBlocks.GRIST_BLOCK_RUBY, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_RUST = registerBlockItem(MSBlocks.GRIST_BLOCK_RUST, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_SHALE = registerBlockItem(MSBlocks.GRIST_BLOCK_SHALE, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_SULFUR = registerBlockItem(MSBlocks.GRIST_BLOCK_SULFUR, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_TAR = registerBlockItem(MSBlocks.GRIST_BLOCK_TAR, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_URANIUM = registerBlockItem(MSBlocks.GRIST_BLOCK_URANIUM, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> GRIST_BLOCK_ZILLIUM = registerBlockItem(MSBlocks.GRIST_BLOCK_ZILLIUM, MSItemGroup.MAIN);
	...
	public static final RegistryObject<BlockItem> SBAHJ_BEDROCK = registerBlockItem(MSBlocks.SBAHJ_BEDROCK, MSItemGroup.MAIN);
	public static final RegistryObject<BlockItem> ZILLYSTONE = registerBlockItem(MSBlocks.ZILLYSTONE, MSItemGroup.MAIN);
