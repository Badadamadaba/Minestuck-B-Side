package com.mcastudios.minestuck.data.recipe;

import com.mcastudios.minestuck.Minestuck;
import com.mcastudios.minestuck.block.BlockCollections;
...
public class MinestuckCombinationsProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		//Grist Blocks
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_AMBER.get()).input(Items.STONE).and().namedInput(MSItems.AMBER_GUMMY_WORM.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_AMETHYST.get()).input(Items.STONE).and().namedInput(MSItems.AMETHYST_HARD_CANDY.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_ARTIFACT.get()).input(Items.STONE).and().namedInput(MSItems.ARTIFACT_WARHEAD.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_BUILD.get()).input(Items.STONE).and().namedInput(MSItems.BUILD_GUSHERS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_CAULK.get()).input(Items.STONE).and().namedInput(MSItems.CAULK_PRETZEL.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_CHALK.get()).input(Items.STONE).and().namedInput(MSItems.CHALK_CANDY_CIGARETTE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_COBALT.get()).input(Items.STONE).and().namedInput(MSItems.COBALT_GUM.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_DIAMOND.get()).input(Items.STONE).and().namedInput(MSItems.DIAMOND_MINT.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_GARNET.get()).input(Items.STONE).and().namedInput(MSItems.GARNET_TWIX.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_GOLD.get()).input(Items.STONE).and().namedInput(MSItems.GOLD_CANDY_RIBBON.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_IODINE.get()).input(Items.STONE).and().namedInput(MSItems.IODINE_LICORICE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_MARBLE.get()).input(Items.STONE).and().namedInput(MSItems.MARBLE_JAWBREAKER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_MERCURY.get()).input(Items.STONE).and().namedInput(MSItems.MERCURY_SIXLETS.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_QUARTZ.get()).input(Items.STONE).and().namedInput(MSItems.QUARTZ_JELLY_BEAN.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_RUBY.get()).input(Items.STONE).and().namedInput(MSItems.RUBY_LOLLIPOP.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_RUST.get()).input(Items.STONE).and().namedInput(MSItems.RUST_GUMMY_EYE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_SHALE.get()).input(Items.STONE).and().namedInput(MSItems.SHALE_PEEP.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_SULFUR.get()).input(Items.STONE).and().namedInput(MSItems.SULFUR_CANDY_APPLE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_TAR.get()).input(Items.STONE).and().namedInput(MSItems.TAR_LICORICE.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_URANIUM.get()).input(Items.STONE).and().namedInput(MSItems.URANIUM_GUMMY_BEAR.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.GRIST_BLOCK_ZILLIUM.get()).input(Items.STONE).and().namedInput(MSItems.ZILLIUM_SKITTLES.get()).build(consumer);
		...
		//Outfits, we'll be spending a lot of time here...
		...
		//Caked up on a thursday afternoon
		...
		//I don't think this stuff's edible
		...
		//Zillystone progression
		CombinationRecipeBuilder.of(MSBlocks.SBAHJ_BEDROCK.get()).input(Blocks.BEDROCK).and().input(MSItems.SBAHJ_POSTER.get()).build(consumer);
		CombinationRecipeBuilder.of(MSBlocks.ZILLYSTONE.get()).input(MSBlocks.SBAHJ_BEDROCK.get()).or().input(MSItems.ZILLIUM_SKITTLES.get());
		CombinationRecipeBuilder.of(MSItems.MOONSTONE.get()).input(MSItems.RAW_CRUXITE.get()).and().input(Blocks.END_STONE);
		CombinationRecipeBuilder.of(MSItems.MOONSTONE_CHISEL.get()).input(MSItems.MOONSTONE.get()).and().input(MSItems.CARVING_TOOL.get());
