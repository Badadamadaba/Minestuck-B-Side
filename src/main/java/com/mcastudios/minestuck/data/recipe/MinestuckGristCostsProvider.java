...
import com.mcastudios.minestuck.util.ExtraForgeTags;
...
import static com.mcastudios.minestuck.alchemy.GristTypes.*;
...
public class MinestuckGristCostsProvider extends RecipeProvider
{
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> recipeSaver)
	{
		...
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_AMBER.get()).grist(AMBER, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_AMETHYST.get()).grist(AMETHYST, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_ARTIFACT.get()).grist(ARTIFACT, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_BUILD.get()).grist(BUILD, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_CAULK.get()).grist(CAULK, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_CHALK.get()).grist(CHALK, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_COBALT.get()).grist(COBALT, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_DIAMOND.get()).grist(DIAMOND, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_GARNET.get()).grist(GARNET, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_GOLD.get()).grist(GOLD, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_IODINE.get()).grist(IODINE, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_MARBLE.get()).grist(MARBLE, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_MERCURY.get()).grist(MERCURY, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_QUARTZ.get()).grist(QUARTZ, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_RUBY.get()).grist(RUBY, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_RUST.get()).grist(RUST, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_SHALE.get()).grist(SHALE, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_SULFUR.get()).grist(SULFUR, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_TAR.get()).grist(TAR, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_URANIUM.get()).grist(URANIUM, 1000).build(recipeSaver);
		GristCostRecipeBuilder.of(MSBlocks.GRIST_BLOCK_ZILLIUM.get()).grist(ZILLIUM, 1000).build(recipeSaver);
		...
		//Zillystone prog
		GristCostRecipeBuilder.of(MSBlocks.SBAHJ_BEDROCK.get()).grist(ARTIFACT, 2000).build(recipeSaver);
