...
import com.mcastudios.minestuck.client.gui.*;
import com.mcastudios.minestuck.client.gui.captchalouge.HashMapSylladexScreen;
import com.mcastudios.minestuck.client.gui.captchalouge.SylladexScreen;
import com.mcastudios.minestuck.client.gui.captchalouge.TreeSylladexScreen;
import com.mcastudios.minestuck.client.gui.playerStats.*;
import com.mcastudios.minestuck.client.util.GuiUtil;
import com.mcastudios.minestuck.client.util.MSKeyHandler;
import com.mcastudios.minestuck.command.*;
import com.mcastudios.minestuck.command.argument.*;
import com.mcastudios.minestuck.computer.ButtonListProgram;
...
import com.mcastudios.minestuck.item.MSItemGroup;
...
import com.mcastudios.minestuck.item.loot.MSLootEvents;
import com.mcastudios.minestuck.item.weapon.MusicPlayerWeapon;
import com.mcastudios.minestuck.item.weapon.OnHitEffect;
...
import com.mcastudios.minestuck.skaianet.*;
...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		addBlock(MSBlocks.GRIST_BLOCK_AMBER, "Amber Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_AMETHYST, "Amethyst Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_ARTIFACT, "Artifact Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_BUILD , "Build Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_CAULK , "Caulk Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_CHALK , "Chalk Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_COBALT , "Cobalt Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_DIAMOND , "Diamond Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_GARNET , "Garnet Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_GOLD ,"Gold Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_IODINE , "Iodine Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_MARBLE , "Marble Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_MERCURY , "Mercury Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_QUARTZ , "Quartz Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_RUBY , "Ruby Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_RUST , "Rust Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_SHALE , "Shale Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_SULFUR , "Sulfur Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_TAR , "Tar Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_URANIUM , "Uranium Grist Block");
		addBlock(MSBlocks.GRIST_BLOCK_ZILLIUM , "Zillium Grist Block");
		...
		addBlock(MSBlocks.SBAHJ_BEDROCK, "Artifact Bedrock");
		addBlock(MSBlocks.ZILLYSTONE, "Zillystone");
		...
		addItem(MSItems.MOONSTONE, "Moonstone");
		addItem(MSItems.MOONSTONE_CHISEL, "Moonstone Chisel");
		addItemTooltip(MSItems.MOONSTONE_CHISEL, "Just by holding it you can feel how magical it is, yet it's not strong enough to chisel a block of stone.");
