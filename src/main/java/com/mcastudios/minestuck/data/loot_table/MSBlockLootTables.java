...
public class MSBlockLootTables extends BlockLoot
{
	...
	protected void addTables()
	{
		...
		dropSelf(GRIST_BLOCK_AMBER.get());
		dropSelf(GRIST_BLOCK_AMETHYST.get());
		dropSelf(GRIST_BLOCK_ARTIFACT.get());
		dropSelf(GRIST_BLOCK_BUILD.get());
		dropSelf(GRIST_BLOCK_CAULK.get());
		dropSelf(GRIST_BLOCK_CHALK.get());
		dropSelf(GRIST_BLOCK_COBALT.get());
		dropSelf(GRIST_BLOCK_DIAMOND.get());
		dropSelf(GRIST_BLOCK_GARNET.get());
		dropSelf(GRIST_BLOCK_GOLD.get());
		dropSelf(GRIST_BLOCK_IODINE.get());
		dropSelf(GRIST_BLOCK_MARBLE.get());
		dropSelf(GRIST_BLOCK_MERCURY.get());
		dropSelf(GRIST_BLOCK_QUARTZ.get());
		dropSelf(GRIST_BLOCK_RUBY.get());
		dropSelf(GRIST_BLOCK_RUST.get());
		dropSelf(GRIST_BLOCK_SHALE.get());
		dropSelf(GRIST_BLOCK_SULFUR.get());
		dropSelf(GRIST_BLOCK_TAR.get());
		dropSelf(GRIST_BLOCK_URANIUM.get());
		dropSelf(GRIST_BLOCK_ZILLIUM.get());
		
		dropSelf(ZILLYSTONE.get());
		add(SBAHJ_BEDROCK.get(), noDrop());
	}
