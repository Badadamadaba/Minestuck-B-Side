...
import com.mcastudios.minestuck.block.fluid.FlowingModFluidBlock;
import com.mcastudios.minestuck.block.fluid.FlowingWaterColorsBlock;
import com.mcastudios.minestuck.block.machine.*;
import com.mcastudios.minestuck.block.plant.*;
import com.mcastudios.minestuck.block.redstone.*;
...
public class MSBlocks
{
	...
	public static final RegistryObject<Block> GRIST_BLOCK_AMBER = REGISTER.register("grist_amber_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.YELLOW).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_AMETHYST = REGISTER.register("grist_amethyst_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.PURPLE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_ARTIFACT = REGISTER.register("grist_artifact_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.GRAY).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_BUILD = REGISTER.register("grist_build_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.BLUE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_CAULK = REGISTER.register("grist_caulk_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.GRAY).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_CHALK = REGISTER.register("grist_chalk_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.WHITE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_COBALT = REGISTER.register("grist_cobalt_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.BLUE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_DIAMOND = REGISTER.register("grist_diamond_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.LIGHT_BLUE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_GARNET = REGISTER.register("grist_garnet_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.RED).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_GOLD = REGISTER.register("grist_gold_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.YELLOW).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_IODINE = REGISTER.register("grist_iodine_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.ORANGE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_MARBLE = REGISTER.register("grist_marble_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.WHITE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_MERCURY = REGISTER.register("grist_mercury_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.GRAY).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_QUARTZ = REGISTER.register("grist_quartz_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.WHITE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_RUBY = REGISTER.register("grist_ruby_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.RED).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_RUST = REGISTER.register("grist_rust_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.RED).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_SHALE = REGISTER.register("grist_shale_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.PURPLE).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_SULFUR = REGISTER.register("grist_sulfur_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.YELLOW).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_TAR = REGISTER.register("grist_tar_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.BLACK).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_URANIUM = REGISTER.register("grist_uranium_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.GREEN).strength(1.0F)));
	public static final RegistryObject<Block> GRIST_BLOCK_ZILLIUM = REGISTER.register("grist_zillium_block", () -> new Block(Block.Properties.of(Material.VEGETABLE, DyeColor.BLUE).strength(1.0F)));
