...
import com.mcastudios.minestuck.inventory.OptionalPosHolder;
import com.mcastudios.minestuck.inventory.SendificatorMenu;
...
public class SendificatorBlockEntity extends MachineProcessBlockEntity implements MenuProvider
{
	...
	/**
	 * With the given container possessing block entity system our mod uses, this is the function that connects to the GoButton found in it's screen({@link com.mcastudios.minestuck.client.gui.SendificatorScreen} in this example)
	 */
	@Override
